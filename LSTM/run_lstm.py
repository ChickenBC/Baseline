...
parser.add_argument('--dataset_path', type=str, default='./dataset/CHI_crime/Offense_0.csv')
...
model_save_path = args.save_path + "LSTM_NN_trained_" + args.dataset_path[-12:-4] + "_" + str(args.out_time)
device = args.device

# Data setup
data = CrimeData(device=device,
